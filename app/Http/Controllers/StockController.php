...
class StockController extends Controller
{
	...
	//funcao para pegar valores no alphavantage, implementada solucao melhor no api.php
// 				public function getquote()
//     	{
// 					$stock = 'ITSA3.SA';
// 					$jsonurl = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=" . $stock . "&apikey=" . env('APLHAVANTAGE_APIKEY');
// 					$json = file_get_contents($jsonurl);
// 					$stockquote = json_decode($json);
// 					//return response()->json($stockquote);
// 					return view('stocks.getquote', ['stocks' => $stocks]);
// 				}
